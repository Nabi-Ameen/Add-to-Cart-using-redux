        ...
        <div className='flex justify-between'>
            <div className='flex items-center'>
                ...
                <div className='space-y-2 px-1'>
                    <p className='text-[16px] md:text-lg font-semibold text-gray-600'>{title}</p>
            ...
            <div className='flex flex-col justify-center items-center'>
                <i className='text-2xl cursor-pointer transition-all hover:border-purple-800 text-purple-800' onClick={() => {
